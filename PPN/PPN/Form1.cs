...
namespace PPN
{
    public partial class Form1 : Form
    {
        ...
        private void btn_Dism_Click(object sender, EventArgs e)
        {
            comando = "DISM.exe /Online /Cleanup-image /Restorehealth";

            ExecutaCmd();
        }

        private void btn_ReiniciarExplorer_Click(object sender, EventArgs e)
        {
            try
            {
                // Encontra o processo do Windows Explorer
                Process[] processes = Process.GetProcessesByName("explorer");

                // Encerra todos os processos do Windows Explorer
